...
model.add(layers.Conv2D(input_shape=(32,32,3),filters=64,kernel_size=(3,3)))
...
# Se muestra una de las soluciones por pantalla cuando se le aplica la capa de pooling
